---
title: "Dead Presentation Visuals and Tables"
format: html
editor: visual
jupyter: python3
---
...
# Plot Total Sales by Alcohol type - Pie chart
plot_data = (
...
# Mean sales per person for each county
sales_per_person = (grouped_data_dead.groupby('county').agg(
        total_sales=('sum_sale_dollars', 'sum'),
        average_population=('population', 'mean')
).reset_index())

sales_per_person['sales_per_person'] = (sales_per_person['total_sales'] / sales_per_person['average_population'])

# Top 25 counties by sales per person
top25_sales_per_person = sales_per_person.sort_values(by='sales_per_person', ascending=False).head(25)

# Print table
print(top25_sales_per_person.to_string(index=False))
```